#!/usr/bin/env bash
# tickets-created.sh <slug> <resume_sig> <project>
# Handles event:tickets-created (ticketer): marks Done, unblocks worker, notifies Spokesman.
...
log_event "tickets-created-ack" "$SLUG"
...
forward_to_spokesman "$SLUG" "event:tickets-created"
